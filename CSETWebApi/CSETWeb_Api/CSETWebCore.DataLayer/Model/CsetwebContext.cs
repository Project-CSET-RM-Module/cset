...
namespace CSETWebCore.DataLayer.Model
{
    public partial class CsetwebContext : DbContext
    {
        ...
        public virtual DbSet<RequirementsSetsCustomFramework> RequirementsSetsCustomFramework { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<ANSWER_LOOKUP>(entity =>
            {
                ...
                entity.Property(e => e.Answer_Full_Name)
                    .IsUnicode(false)
                    .HasComment("The Answer Full Name is used to");
            });
            ...
            modelBuilder.Entity<ASSESSMENT_SELECTED_LEVELS>(entity =>
            {
                ...
                entity.Property(e => e.Level_Name)
                    .IsUnicode(false)
                    .HasComment("The Level Name is used to");

                entity.Property(e => e.Standard_Specific_Sal_Level)
                    .IsUnicode(false)
                    .HasComment("The Standard Specific Sal Level is used to");
            ...
            modelBuilder.Entity<AVAILABLE_STANDARDS>(entity =>
            {
                ...
                entity.Property(e => e.Set_Name)
                    .IsUnicode(false)
                    .HasComment("The Old Entity Name is used to");
            ...
            modelBuilder.Entity<COMPONENT_FAMILY>(entity =>
            {
                ...
                entity.Property(e => e.Component_Family_Name)
                    .IsUnicode(false)
                    .HasComment("The Component Family Name is used to");
            });
            ...
            modelBuilder.Entity<COMPONENT_NAMES_LEGACY>(entity =>
            {
                ...
                entity.Property(e => e.Old_Symbol_Name).IsUnicode(false);
            ...
            modelBuilder.Entity<COMPONENT_SYMBOLS>(entity =>
            {
                ...
                entity.Property(e => e.Abbreviation)
                    .IsUnicode(false)
                    .HasComment("The Abbreviation is used to");
            ...
            modelBuilder.Entity<COMPONENT_SYMBOLS_GM_TO_CSET>(entity =>
            {
                ...
                entity.Property(e => e.GM_FingerType).IsUnicode(false);
            });

            modelBuilder.Entity<CONFIDENTIAL_TYPE>(entity =>
            {
                entity.Property(e => e.ConfidentialTypeKey).IsUnicode(false);
            });
            ...
            modelBuilder.Entity<CSET_VERSION>(entity =>
            {
                ...
                entity.Property(e => e.Cset_Version1)
                    .IsUnicode(false)
                    .HasComment("The Cset Version is used to");
            ...
            modelBuilder.Entity<DEMOGRAPHICS>(entity =>
            {
                ...
                entity.Property(e => e.CriticalService).IsUnicode(false);
            ...
            modelBuilder.Entity<DEMOGRAPHICS_ORGANIZATION_TYPE>(entity =>
            {
                ...
                entity.Property(e => e.OrganizationType).IsUnicode(false);
            });
            ...
            modelBuilder.Entity<DOCUMENT_FILE>(entity =>
            {
                ...
                entity.Property(e => e.Path)
                    .IsUnicode(false)
                    .HasComment("The Path is used to");
            ...
            modelBuilder.Entity<FILE_TYPE>(entity =>
            {
                ...
                entity.Property(e => e.File_Type1)
                    .IsUnicode(false)
                    .HasComment("The File Type is used to");

                entity.Property(e => e.Mime_Type)
                    .IsUnicode(false)
                    .HasComment("The Mime Type is used to");
            });
            ...
            modelBuilder.Entity<GENERAL_SAL>(entity =>
            {
                ...
                entity.Property(e => e.Sal_Name)
                    .IsUnicode(false)
                    .HasComment("The Sal Weight Id is used to");
            ...
            modelBuilder.Entity<GLOBAL_PROPERTIES>(entity =>
            {
                ...
                entity.Property(e => e.Property)
                    .IsUnicode(false)
                    .HasComment("The Property is used to");

                entity.Property(e => e.Property_Value)
                    .IsUnicode(false)
                    .HasComment("The Property Value is used to");
            });
            ...
            modelBuilder.Entity<INSTALLATION>(entity =>
            {
                ...
                entity.Property(e => e.Installation_ID).IsUnicode(false);

                entity.Property(e => e.JWT_Secret).IsUnicode(false);
            });
            ...
            modelBuilder.Entity<MATURITY_DOMAIN_REMARKS>(entity =>
            {
                ...
                entity.Property(e => e.DomainRemarks).IsUnicode(false);
            ...
            modelBuilder.Entity<MATURITY_QUESTIONS>(entity =>
            {
                ...
                entity.Property(e => e.Examination_Approach).IsUnicode(false);
            ...
            modelBuilder.Entity<NEW_QUESTION>(entity =>
            {
                ...
                entity.Property(e => e.Std_Ref_Id)
                    .IsUnicode(false)
                    .HasComputedColumnSql("(case when [std_ref]=NULL then NULL else ([Std_Ref]+'.')+CONVERT([varchar](50),[Std_Ref_Number],(0)) end)", false);
            ...
            modelBuilder.Entity<NEW_QUESTION_LEVELS>(entity =>
            {
                ...
                entity.Property(e => e.Universal_Sal_Level)
                    .IsUnicode(false)
                    .HasComment("The Universal Sal Level is used to");
            ...
            modelBuilder.Entity<NEW_QUESTION_SETS>(entity =>
            {
                ...
                entity.Property(e => e.Set_Name)
                    .IsUnicode(false)
                    .HasComment("The Set Name is used to");
            ...
            modelBuilder.Entity<NIST_SAL_QUESTIONS>(entity =>
            {
                ...
                entity.Property(e => e.Question_Text)
                    .IsUnicode(false)
                    .HasComment("The Question Text is used to");
            });
            ...
            modelBuilder.Entity<QUESTION_GROUP_HEADING>(entity =>
            {
                ...
                entity.Property(e => e.Std_Ref)
                    .IsUnicode(false)
                    .HasComment("The Std Ref is used to");
            ...
            modelBuilder.Entity<QUESTION_GROUP_TYPE>(entity =>
            {
                ...
                entity.Property(e => e.Group_Header)
                    .IsUnicode(false)
                    .HasComment("The Group Header is used to");

                entity.Property(e => e.Group_Name)
                    .IsUnicode(false)
                    .HasComment("The Group Name is used to");

                entity.Property(e => e.Scoring_Group)
                    .IsUnicode(false)
                    .HasComment("The Scoring Group is used to");

                entity.Property(e => e.Scoring_Type)
                    .IsUnicode(false)
                    .HasComment("The Scoring Type is used to");
            });
            ...
            modelBuilder.Entity<REFERENCE_DOCS>(entity =>
            {
                ...
                entity.Property(e => e.Doc_Short)
                    .IsUnicode(false)
                    .HasComment("The Doc Short is used to");
            ...
            modelBuilder.Entity<REQUIREMENT_LEVELS>(entity =>
            {
                ...
                entity.Property(e => e.Standard_Level)
                    .IsUnicode(false)
                    .HasComment("The Standard Level is used to");

                entity.Property(e => e.Level_Type)
                    .IsUnicode(false)
                    .HasComment("The Level Type is used to");
            ...
            modelBuilder.Entity<REQUIREMENT_LEVEL_TYPE>(entity =>
            {
                ...
                entity.Property(e => e.Level_Type_Full_Name)
                    .IsUnicode(false)
                    .HasComment("The Level Type Full Name is used to");
            });
            ...
            modelBuilder.Entity<RequirementsCustomFramework>(entity =>
            {
                entity.Property(e => e.Implementation_Recommendations).IsUnicode(false);
            ...
            modelBuilder.Entity<RequirementsSetsCustomFramework>(entity =>
            {
                entity.Property(e => e.Set_Name).IsUnicode(false);
            });
            ...
            modelBuilder.Entity<SAL_DETERMINATION_TYPES>(entity =>
            {
                ...
                entity.Property(e => e.Sal_Determination_Type).IsUnicode(false);
            });
            ...
            modelBuilder.Entity<SETS>(entity =>
            {
                ...
                entity.Property(e => e.Full_Name)
                    .IsUnicode(false)
                    .HasComment("The Full Name is used to");
                ...
                entity.Property(e => e.Old_Std_Name)
                    .IsUnicode(false)
                    .HasComment("The Old Std Name is used to");
            ...
            modelBuilder.Entity<STANDARD_CATEGORY>(entity =>
            {
                ...
                entity.Property(e => e.Standard_Category1)
                    .IsUnicode(false)
                    .HasComment("The Standard Category is used to");
            });
            ...
            modelBuilder.Entity<SYMBOL_GROUPS>(entity =>
            {
                ...
                entity.Property(e => e.Symbol_Group_Name)
                    .IsUnicode(false)
                    .HasComment("The Symbol Group Name is used to");

                entity.Property(e => e.Symbol_Group_Title)
                    .IsUnicode(false)
                    .HasComment("The Symbol Group Title is used to");
            });
            ...
            modelBuilder.Entity<UNIVERSAL_AREA>(entity =>
            {
                ...
                entity.Property(e => e.Universal_Area_Name)
                    .IsUnicode(false)
                    .HasComment("The Universal Area Name is used to");
            ...
            modelBuilder.Entity<UNIVERSAL_SAL_LEVEL>(entity =>
            {
                ...
                entity.Property(e => e.Full_Name_Sal)
                    .IsUnicode(false)
                    .HasComment("The Full Name Sal is used to");
            ...
            modelBuilder.Entity<UNIVERSAL_SUB_CATEGORIES>(entity =>
            {
                ...
                entity.Property(e => e.Universal_Sub_Category)
                    .IsUnicode(false)
                    .HasComment("The Universal Sub Category is used to");
