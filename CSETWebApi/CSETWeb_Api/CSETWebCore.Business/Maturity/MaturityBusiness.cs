...
namespace CSETWebCore.Business.Maturity
{
    public class MaturityBusiness : IMaturityBusiness
    {
        ...
        // public void Get_LevelScoresByGroup(int assessment_id, int mat_model_id)
        // {
        //     var list = _context.usp_countsForLevelsByGroupMaturityModel().ToList();
        // }
        ...
        private Dictionary<usp_countsForLevelsByGroupMaturityModelResults, int> levels =
            new Dictionary<usp_countsForLevelsByGroupMaturityModelResults, int>();
